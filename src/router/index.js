...
import Admin_Layout from '@/views/layout/Admin_Layout'
...
export const asyncRoutes = [{
    ...
    children: [{
        path: 'applets',
        component: () => import('@/views/applets/relation'),
        name: 'applets',
        meta: {
          perms: ['GET /admin/mini/list'],
          title: '关联小程序',
          noCache: true
        }
      }
      ...
      // },
      // {
      //   path: 'applets_recycle',
      //   component: () => import('@/views/applets/recycle'),
      //   name: 'applets_recycle',
      //   meta: {
      //     perms: ['GET /admin/user/list'],
      //     title: '小程序回收站',
      //     noCache: true
...

  {
    ...
    children: [{
        ...
        name: 'goodsList',
        meta: {
          perms: ['GET /admin/mini/product', 'POST /admin/goods/delete'],
          title: '商品列表',
          noCache: true
        }
      },
  ...
  //   name: 'externalLink',
  //   meta: {
  //     perms: ['GET /admin/externalLink/list'],
  //     title: '外链',
  //     icon: 'link'
  //   },
  //   children: [{
