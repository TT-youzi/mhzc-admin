<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column align="center" label="管理员名称" prop="nickName" />
      ...
      <el-table-column align="center" label="管理员角色" prop="roleIds">
        <template slot-scope="scope" v-if="scope.row.roleIds">
          <el-tag
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      let currUserName = this.$store.state.user.name
      deleteAdmin({
        id:row.id,
